  ...
  <div class="admin-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="YouTube 影片網址">
        <el-input v-model="youtubeInput" placeholder="請貼上 YouTube 分享網址，如 https://www.youtube.com/watch?v=XXXXX" />
      </el-form-item>
...
const bannerText = ref(localStorage.getItem('home_bannerText') || '專業數據分析、個人化健康計劃，全方位追蹤功能，讓健康管理更簡單有效');
const promoTexts = ref(JSON.parse(localStorage.getItem('home_promoTexts') || '["廣告一文案", "廣告二文案", "廣告三文案"]'));
const videoUrl = ref(localStorage.getItem('home_videoUrl') || 'https://www.youtube.com/embed/WUZZ0N7pmlc');
const youtubeInput = ref(videoUrl.value.replace('https://www.youtube.com/embed/', 'https://www.youtube.com/watch?v='));
