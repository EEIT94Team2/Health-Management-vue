...
<template>
    <div class="health-platform dark-theme">
                        ...
                        <div class="course-card">
                            ...
                            <div class="course-content">
                                ...
                                <div class="course-info">
                                    <span
                                        ><el-icon><User /></el-icon> {{ course.coach }}</span
                                    >
                                    <span
                                        ><el-icon><Clock /></el-icon> {{ course.duration }}</span
                                    >
                                </div>
                    ...
                    <el-col :xs="24" :sm="12" :md="6" v-for="coach in coaches" :key="coach.id">
                        <div class="coach-card">
                            <div class="coach-image">
                                <img
                                    :src="coach.image || 'https://via.placeholder.com/200x200'"
                                    :alt="coach.name"
                                    class="rounded-full"
                                />
                            </div>
                            ...
                            <el-button type="info" size="small" @click="viewCoachProfile(coach.id)"
                                >了解更多</el-button
                            >
                        </div>
                    </el-col>
                    ...
                    <el-carousel-item v-for="testimonial in testimonials" :key="testimonial.id">
                        <div class="testimonial-card">
                            ...
                            <div class="author">
                                ...
                                <span class="info"
                                    >{{ testimonial.age }}, {{ testimonial.occupation }}</span
                                >
                            </div>
                        </div>
                    </el-carousel-item>
        ...
        <section class="contact-section">
            <div class="container">
                <h2 class="section-title">
                    聯絡我們 / 預約<span class="text-highlight">體驗</span>
                </h2>
        ...
        const coaches = ref([
            {
                ...
                name: "張志明",
                specialty: "體能訓練專家",
                image: "https://via.placeholder.com/200x200/00BCD4/FFFFFF?Text=Coach+A",
            },
            {
                id: 202,
                name: "李美玲",
                specialty: "瑜珈與皮拉提斯",
                image: "https://via.placeholder.com/200x200/E91E63/FFFFFF?Text=Coach+B",
            },
            {
                id: 203,
                name: "王強",
                specialty: "重量訓練與營養",
                image: "https://via.placeholder.com/200x200/673AB7/FFFFFF?Text=Coach+C",
            },
            {
                id: 204,
                name: "陳小華",
                specialty: "水中運動與復健",
                image: "https://via.placeholder.com/200x200/FF9800/FFFFFF?Text=Coach+D",
            },
        ]);
        ...
        const testimonials = ref([
            {
                ...
                age: 32,
                occupation: "上班族",
                quote: "加入平台後，我成功減掉了 8 公斤，而且更有活力了！感謝教練的專業指導和系統化的追蹤工具。",
            },
            {
                id: 302,
                name: "陳先生",
                age: 45,
                occupation: "工程師",
                quote: "這個平台幫助我養成了規律運動的習慣，身體狀況明顯改善，睡眠品質也提升了。",
            },
            {
                id: 303,
                name: "黃同學",
                age: 20,
                occupation: "學生",
                quote: "透過飲食追蹤和運動記錄功能，我更了解自己的身體，也達成了設定的健身目標！",
            },
        ]);
