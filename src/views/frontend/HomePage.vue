      ...
      <section class="products-section" id="products">
        <div class="section-container">
          <div class="section-header">
            <h2 class="section-title"><span class="title-text">健康 <span class="text-highlight"> 精選商品</span></span></h2>
          ...
          <el-row v-else :gutter="20" class="product-list">
            <el-col :xs="24" :sm="12" :md="6" v-for="(product, index) in displayProducts" :key="product.id">
              <div class="product-card" @click="viewProductDetail(product.id)">
                ...
                <div class="product-content">
                  ...
                  <div class="product-actions">
                    <el-button type="success" @click.stop="addProductToCart(product)">
                      加入購物車
                    </el-button>
                  </div>
                </div>
...
export default {
  ...
  setup() {
    ...
    const getDefaultProductImage = (productName) => {
      ...
      return `https://placehold.co/400x300/${color}/ffffff?text=${encodeURIComponent(productName)}`;
    };
