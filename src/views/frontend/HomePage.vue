...
<template>
    ...
    <header class="main-header">
      <div class="container">
        <div class="header-content">
          <div class="logo">
            <router-link to="/" @click.prevent="scrollToTop">享健你，遇見更好的自己</router-link>
          </div>
          <nav class="main-nav">
            <ul>
              <li><a href="#membership">會員中心</a></li>
              <li><a href="#courses">課程查詢</a></li>
              <li><a href="#products">購物商城</a></li>
              <li><a href="#features">健康管理</a></li>
              <li><a href="#social">社群論壇</a></li>
              <li><a href="#contact">聯絡我們</a></li>
            </ul>
          </nav>
          <div class="header-buttons">
            <el-button size="medium">登入</el-button>
            <el-button type="primary" size="medium" @click="scrollToContact">免費體驗</el-button>
          </div>
        </div>
      </div>
    </header>
    ...
    <section class="hero-section">
      ...
      <div class="hero-content container">
        ...
        <p>專業數據分析、個人化健康計劃、全方位追蹤功能，<br>讓健康管理更簡單有效</p>
...
<section class="features-section" id="features">
 ...
 <section class="testimonial-section">
  ...
  <footer id="page-bottom">
    <p>Copyright © 2025 享健你，遇見更好的自己.　All rights reserved.</p>
  </footer>
</div>
</template>
  ...
  },
  {
    ...
    const fetchPopularProducts = async () => {
      try {
        ...
        popularProducts.value = (response.data || []).slice(0, 6) // 在前端截取前 6 個
      } catch (error) {
...
.hero-content {
  ...
  .btn-secondary { /* 針對 "瞭解功能" 按鈕 */
    ...
    &:hover {
      ...
      color: #369169 !important; /* hover 時稍微變深的文字顏色 */
    }
  }
}
...
.main-header {
  ...
  left: 0;
  z-index: 1000;
  background-image: linear-gradient(to bottom, #10202B 100%); /* 調整顏色和透明度 */
...
.header-buttons {
  ...
  .el-button { /* 針對所有 el-button */
    background-color: transparent; /* 先移除預設背景色 */
    color: #f5f5f5; /* 設定文字顏色 */
    border: 1px solid #42b883; /* 添加邊框 */

    &:hover {
      background-color: rgba(66, 184, 131, 0.1); /* hover 時的微弱背景 */
      color: #8dfac9; /* hover 時的文字顏色 */
      border-color: #42b883;
    }
  }

  .el-button--primary { /* 針對 type="primary" 的 el-button (免費體驗) */
    background-color: #42b883; /* 設定背景色為指定顏色 */
    color: #fff; /* 設定文字顏色為白色 */
    border: none; /* 移除邊框 */

    &:hover {
      background-color: #368e68; /* hover 時稍微變深的顏色 */
    }
  }
}
