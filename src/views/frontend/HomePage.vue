<template>
  ...
  <div class="homepage-content">
    <div class="health-platform dark-theme">
      ...
      <section class="hero-section">
        ...
        <div class="hero-content container">
          ...
          <div class="hero-buttons">
            <el-button type="success" size="large" class="btn-primary" @click="redirectToLogin">
              立即開始
            </el-button>
            <el-button plain size="large" class="btn-secondary" @click="scrollToFeatures">
              瞭解功能
            </el-button>
          </div>
        </div>
            ...
            <el-col :xs="24" :sm="12" :md="8" v-for="course in popularCourses" :key="course.id">
              <div class="course-card">
                <div class="course-image">
                  <img
                    :src="course.image || 'https://placehold.co/300x200/FFC107/000000?text=HIIT'"
                    :alt="course.name"
          ...
          <div class="trainers-grid">
            <div class="trainer-card" v-for="trainer in trainers" :key="trainer.id">
              <div class="trainer-image">
                <img
                  :src="trainer.photo || 'https://placehold.co/300x400/777777/ffffff?text=Trainer'"
                  :alt="trainer.name"
      ...
      <!-- 商品區塊 -->
      <section class="products-section" v-if="popularProducts.length > 0" id="products">
        <div class="container">
          <div class="section-header">
            <h2 class="section-title">
              健康 <span class="text-highlight">精選商品</span>
            </h2>
            ...
            <el-col :xs="24" :sm="12" :md="8" v-for="product in popularProducts" :key="product.id">
              <div class="product-card">
                <div class="product-image">
                  <img
                    :src="product.image || 'https://placehold.co/300x300/4CAF50/ffffff?text=Product'"
                    :alt="product.name"
                ...
                <div class="product-content">
                  ...
                  <div class="product-actions">
                    <el-button type="success" @click="addProductToCart(product)">
                      加入購物車
                    </el-button>
                  </div>
                </div>
              ...
              <div class="testimonial-card">
                <div class="testimonial-content">
                  ...
                  <div class="testimonial-author">
                    <img
                      :src="testimonial.avatar || 'https://placehold.co/100x100/cccccc/ffffff?text=Avatar'"
            ...
            <div class="contact-form">
              ...
              <el-form :model="contactForm" ref="contactFormRef">
                ...
                <div class="header-buttons">
                  <el-form-item>
                    <el-button class="send-btn" type="primary" @click="submitContactForm">
                      <el-icon><Message /></el-icon>發送訊息
                    </el-button>
                    <el-button class="booking-btn" @click="showBookingModal = true">
        ...
        <div class="container">
          <div class="subscribe-content">
            ...
            <div class="subscribe-form">
              ...
              <el-button type="success" @click="submitSubscription"><i class="bi bi-bell"></i>&nbsp;&nbsp;立即訂閱</el-button>
            </div>
          </div>
        </div>
      </section>
  ...
  setup() {
    ...
    const fetchPopularProducts = async () => {
      try {
        ...
        popularProducts.value = (response.data || []).slice(0, 6)
      } catch (error) {
...
padding: 0 2rem;
width: 100%;
animation: backgroundImageSlideshow 15s infinite; /* 新增輪播動畫 */
}
...
// 商品區塊
.products-section {
padding: 4rem 0; /* 可以稍微減少上下 padding */
background-color: var(--bg-secondary);
...
overflow: hidden;
transition: all 0.3s ease;
height: auto; /* 改為 auto，讓高度根據內容自適應 */
display: flex;
flex-direction: column;
border: 1px solid var(--border-color);

&:hover {
  transform: translateY(-3px); /* 相應減少 hover 位移 */
  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.15); /* 相應減少 hover 陰影 */
}
...
.product-image {
  ...
  img {
    ...
    &:hover {
      transform: scale(1.03); /* 相應減少 hover 縮放 */
    }
  }
}
...
.product-content h3 {
  font-size: 1rem; /* 減小標題字體大小 */
  margin-bottom: 0.3rem; /* 相應減少間距 */
  color: var(--highlight-color);
}

.product-description {
  color: var(--text-secondary);
  font-size: 0.8rem; /* 減小描述字體大小 */
  margin-bottom: 0.5rem; /* 相應減少間距 */
  flex-grow: 1;
  line-height: 1.4; /* 調整行高，使小字體更易讀 */
}

.product-price {
  font-size: 1.1rem; /* 減小價格字體大小 */
  font-weight: 600;
  color: var(--highlight-color);
  margin-bottom: 0.5rem; /* 相應減少間距 */
}
...
.product-actions {
  .el-button {
    font-size: 0.8rem; /* 減小按鈕字體大小 */
    padding: 0.6rem 1rem; /* 減小按鈕內邊距 */
    background-color: var(--highlight-color);
    color: var(--text-primary);
    border: none;
