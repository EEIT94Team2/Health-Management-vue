<template>
    ...
    <div class="header-right">
        <div class="header-buttons" v-if="!isAuthenticated">
            ...
            <el-button type="primary" size="medium" @click="handleRegister"> 免費註冊 </el-button>
        </div>
        ...
        >
            ...
            <ul class="dropdown" :class="{ show: userMenuOpen }">
                ...
                <li @click="userMenuOpen = false" v-if="hasAdminAccess">
    ...
    <header class="main-header">
        <div class="container">
            <div class="header-content">
                <div class="logo" @mouseenter="swapLogo(true)" @mouseleave="swapLogo(false)">
    ...
    >
        <nav class="sidebar-nav">
            <ul>
                <li v-for="menu in sidebarMenus" :key="menu.label" class="nav-item-sidebar">
                    <a href="#" @click.prevent="menu.hash ? handleSidebarNavClick(menu) : null">
                        <i :class="menu.icon"></i>
                        {{ menu.label }}
                    </a>
                </li>
...
// 添加計算屬性來檢查用戶是否有後台管理權限 (admin 或 coach)
...
.nav-item-sidebar a:hover {
    ...
    color: var(--highlight-color, #43a478); /* Use a CSS variable if defined, fallback to green */
...
.header-buttons .el-button {
    ...
    &:focus {
        ...
        background-color: color.adjust(#10b981, $lightness: -10%); /* 懸停時背景色 */
        border-color: color.adjust(#10b981, $lightness: -10%); /* 懸停時邊框色 */
    }
    &:active {
        // 修正 Sass 錯誤：直接使用顏色碼 #10b981 進行 adjust
        background-color: color.adjust(#10b981, $lightness: -20%); /* 點擊時背景色更深 */
        border-color: color.adjust(#10b981, $lightness: -20%); /* 點擊時邊框色更深 */
        color: #fff; /* 確保文字顏色 */
    }
}
...
.header-buttons .el-button--primary {
    ...
    &:focus {
        // 修正 Sass 錯誤：直接使用顏色碼 #10b981 進行 adjust
        background-color: color.adjust(#10b981, $lightness: -10%); /* 懸停時背景色變深 */
        border-color: color.adjust(#10b981, $lightness: -10%); /* 懸停時邊框色變深 */
